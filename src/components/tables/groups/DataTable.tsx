...
export function DataTable<TData, TValue>({
  ...
  if (Object.keys(rowSelection).length > 0 && tableRef.current){
  ...
  const emptyRowsCount = Math.max(9 - (data.length % 9));
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-start w-fit h-full gap-[15px] mt-[10px]">
        <div className="bg-white dark:bg-[#19191A] border rounded-md border-[#E4E4E7] dark:border-[#515152] overflow-hidden" ref={tableRef}>
          <Table>
            <TableHeader>
              ...
              {table.getRowModel().rows?.length ? (
                <>
                  ...
                  {emptyRows.map((_, index) => (
                    <TableRow key={index} className="min-h-14 border-[#E4E4E7] dark:border-[#515152]">
                      <TableCell colSpan={columns.length} className="min-h-14 p-0">
                        <div className="h-14" />
                      </TableCell>
                    </TableRow>
                  ))}
        ...
        <div className="relative flex items-center self-start w-full space-x-2">
          ...
          <Button
            ...
            disabled={Object.keys(updateDict).length == 0}
            onClick={handleSave}
          >
            Save
          </Button>
        ...
        <DropdownMenu open={contextMenu.show}>
          ...
          <DropdownMenuContent onClick={(e) => e.preventDefault()} ref={ref}>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuSub>
              <DropdownMenuAltTrigger asChild>
                <DropdownMenuItem className="flex items-center" onClick={() => null}><span className="bg-clip-text text-transparent bg-gradient-to-r from-[#00AEDF] via-[#8b2dd1] via-[60%] to-[#EC1A23] font-medium">Change status</span><ChevronRight className="w-4 h-4 ml-1 mt-[1.99px]" /></DropdownMenuItem>
              </DropdownMenuAltTrigger>
              <DropdownMenuSubContent>
