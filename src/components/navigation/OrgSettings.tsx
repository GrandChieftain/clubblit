...
export default function OrgSettings(){
    ...
    useEffect(() => form.reset(defaultValues), [defaultValues.club.name])
    ...
    const notAuthorized = (onClick: MouseEventHandler) => <TooltipProvider displayContent={active}>
        <svg onClick={onClick} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke={theme == "dark" ? "#C2C2C2" : "#000000"} className="w-7 h-7 dark:hover:bg-[#272729] hover:border hover:border-transparent hover:bg-black/[0.04] rounded-md">
                    ...
                    <FormField 
                        ...
                        render={({ field }) => (
                            <FormItem className="grid items-center grid-cols-4 gap-4">
                                ...
                                <FormControl>
                                    <Input className="col-span-3" placeholder="" {...field} readOnly />
                                </FormControl>
                            </FormItem>
                        )}
                    />
